...
def preproc():
    ...
    # Getting the list of pages. If you want to do test on a smaller sample, you can either change the folder location or move out some pages (need to be done in ground-truth only)
    ...
    for number in numbers:
        ...
        file = os.path.join('pkl', '%d_words.pkl' % number)
        ...
        #We add a dictionary per page to the list
    ...
    for d in tqdm(_binarised, desc='Dictionary fusion'):
        #Fusion all dictionary into one to normalize them across the board
        binarised.update(d)
